                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="{{ __('view.user.username') }}..."
                                    value="" readonly id="username-user-update-js">
                            </div>
                            <div class="form-group mb-3">
                                <label for="">{{ __('view.user.fullname') }}:</label>
                                <input type="text" class="form-control" placeholder="{{ __('view.user.fullname') }}..."
                                    value="" id="fullname-user-update-js">
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="dropdown d-flex align-items-center w-50 pt-2 pb-2" style="gap: 0 10px;">
                                ...
                                <div class="dropdown-menu" aria-labelledby="permission-user-update-js"
                                    style="overflow: auto !important; height: 150px !important;" id="list-permission-js">
                                </div>
                            </div>
                            <div class="d-flex align-items-center pt-2 pb-2" style="gap: 0 10px;">
